    ...
    <div className="flex w-screen h-screen">
      ...
      >
        <div className="p-10 text-white flex flex-col items-center justify-center">
          ...
          <p className="mb-4">
            Welcome Back! Create Account To keep connected with us please login
            with your personal info Name SIGN IN Email Password SIGN UP
          </p>
      ...
      <div className="w-3/5 p-10 flex items-center justify-center flex-col">
        <h1 className="text-4xl mb-4 font-bold text-yellow">Create Account</h1>
